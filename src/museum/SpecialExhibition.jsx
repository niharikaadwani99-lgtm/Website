...
const LETTER = {
  ...
  paragraphs: [
    ...
    'Over the last few months, we’ve built something so so special and valuable and I’m so excited for everything that is to come. While circumstances may be uncertain, the only thing I’m certain about is you.',
  ],
  signoff: 'Much love,',
  signature: 'Nix',
}
