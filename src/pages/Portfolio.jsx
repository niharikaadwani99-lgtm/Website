...
const ITEMS = [
  ...
  { type: 'swatch', chips: ['#8a9679', '#c9b06a', '#4d4a35'], caption: 'Palette for a monsoon capsule — sage, brass, olive.', r: 2 },
  ...
  { type: 'swatch', chips: ['#7a2e2c', '#d9b8ae', '#2c2417'], caption: 'A burgundy story that almost got cut from the line.', r: -3 },
  ...
  { type: 'swatch', chips: ['#b9c8cf', '#8a9679', '#f2e9d6'], caption: 'Cool tones for a resort line that never launched. Yet.', r: 1 },
]
